(function () {
    ...
    function findLongestWord(str) {
        ...
        for (let i = 0; i < strArr.length; i++) {
          if (strArr[i].length > wordLng && symbolChk.test(strArr[i]) === false) {
          wordLng = strArr[i].length;
          longestWord = i;
           }
        }
        return strArr[longestWord];
      }
      console.log(`
The longest word is: `,'\x1b[31m','\x1b[4m',`${findLongestWord(str)}`, '\x1b[0m');
})();